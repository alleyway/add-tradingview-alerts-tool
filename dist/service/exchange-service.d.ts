...
export declare const BYBIT_INVERSE = "bybit_inverse";
export declare const BYBIT_LINEAR = "bybit_linear";
...
export declare const fetchByBitInverse: () => Promise<MasterSymbol[]>;
export declare const fetchByBitLinear: () => Promise<MasterSymbol[]>;
